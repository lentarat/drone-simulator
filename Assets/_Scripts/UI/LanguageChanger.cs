...
public class LanguageChanger : IInitializable, IDisposable
{
    ...
    {
        _signalBus.Subscribe<PlayerSettingsChangedSignal>(OnPlayerSettingsChanged);
    }

    private void OnPlayerSettingsChanged(PlayerSettingsChangedSignal signal)
    {
    ...
    {
        _signalBus.Unsubscribe<PlayerSettingsChangedSignal>(OnPlayerSettingsChanged);
    }
}
